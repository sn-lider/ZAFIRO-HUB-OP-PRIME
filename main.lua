...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/sn-lider/COPlibarykitsune/refs/heads/main/main.lua", true))()

local player = game.Players.LocalPlayer
local displayName = player.DisplayName or player.Name

local window = library:AddWindow("Zafiro HUB paid by SN | - Bienvenido " .. displayName, {
    main_color = Color3.fromRGB(193, 18, 31),
...
AutoFarm:AddSwitch("Strength Op (No LAG)", function(state)
...
-- Switch en la librería
AutoFarm:AddSwitch("Strength Op (SUPER)", function(state)
    getgenv()._AutoRepFarmEnabled = state
    warn("[Auto Rep Farm] Estado cambiado a:", state and "ON" or "OFF")
end)
...
AutoFarm:AddButton("Dark mode", function()
    local player = game.Players.LocalPlayer
...
AutoFarm:AddButtonEquip ("Swift Samurai 7 or 8 max", function()
...
local Credits = window:AddTab("Warning")

Credits:AddLabel("Paid Versión By SN)
Credits:AddLabel("el dark mode es irreversible")
Credits:AddLabel("ANTI AFK por default)
Credits:AddLabel("disfrutalo")
Credits:AddLabel("farmea como un top☠️")
Credits:AddLabel("gracias por comprarlo")
